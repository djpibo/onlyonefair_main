...
Test that we can run executable scripts.js that have been installed with numpy.
"""
import sys
import os
import pytest
...
def find_f2py_commands():
    if sys.platform == 'win32':
        ...
        # Three scripts.js are installed in Unix-like systems:
        # 'f2py', 'f2py{major}', and 'f2py{major.minor}'. For example,
        # if installed with python3.9 the scripts.js would be named
