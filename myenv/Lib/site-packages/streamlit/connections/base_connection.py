...
"""
    ...
    def _on_secrets_changed(self, _) -> None:
        ...
        We don't expect either user scripts.js or connection authors to have to use or
    ...
    def _secrets(self) -> AttrDict:
        ...
        are implementing their class' ``_connect`` method. User scripts.js should, for the
