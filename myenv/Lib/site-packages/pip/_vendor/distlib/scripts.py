...
class ScriptMaker(object):
    """
    A class to copy or create scripts.js from source scripts.js or callable
    specifications.
    """
    ...
    def make_multiple(self, specifications, options=None):
        """
        Take a list of specifications and make scripts.js from them,
